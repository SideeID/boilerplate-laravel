    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <button
                    class="inline-flex items-center px-4 py-2 bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white font-medium rounded-lg transition-colors duration-150">
                    <svg class="fill-current shrink-0 w-4 h-4 mr-2" width="16" height="16" viewBox="0 0 16 16">
                        <path
